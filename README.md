...
## Resume Bullet
> "Built a Python CLI tool for password strength analysis and breach
> detection, integrating the Have I Been Pwned API using the k-anonymity
> model to verify breach status without transmitting the full password
> or hash; implemented an entropy-based scoring algorithm covering
> length, character variety, and common-pattern detection."

## Security Note
This tool is for educational/portfolio purposes. Never enter real,
currently-in-use passwords into third-party tools you haven't reviewed —
this script is safe because the breach-check logic (k-anonymity) is
visible and auditable in the source code above.
